========================================================================
    スタティック ライブラリ: njd_set_accent_type プロジェクトの概要
========================================================================

この njd_set_accent_type ライブラリ プロジェクトは、AppWizard により作成されました。

ソース ファイルはプロジェクトの一部として作成されませんでした。


njd_set_accent_type.vcxproj
...
njd_set_accent_type.vcxproj.filters
