========================================================================
    スタティック ライブラリ: njd_set_accent_phrase プロジェクトの概要
========================================================================

この njd_set_accent_phrase ライブラリ プロジェクトは、AppWizard により作成されました。

ソース ファイルはプロジェクトの一部として作成されませんでした。


njd_set_accent_phrase.vcxproj
...
njd_set_accent_phrase.vcxproj.filters
