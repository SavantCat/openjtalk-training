========================================================================
    スタティック ライブラリ: njd_set_long_vowel プロジェクトの概要
========================================================================

この njd_set_long_vowel ライブラリ プロジェクトは、AppWizard により作成されました。

ソース ファイルはプロジェクトの一部として作成されませんでした。


njd_set_long_vowel.vcxproj
...
njd_set_long_vowel.vcxproj.filters
